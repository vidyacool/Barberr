...
def main(args):
    ...
    align.align_images(im_path1, im_path2, sign='realistic', align_more_region=False, smooth=2)
    if im_path2 != im_path3:
        align.align_images(im_path1, im_path3, sign='realistic', align_more_region=False, smooth=2, save_intermediate=False)
